<template>
  <div class="public">
    ...
    <div class="change-bill"> 
      <span class="change-radius" @click="changeBill"> <van-icon name="replay" /> 切换海报样式</span>
    </div>
  </div>
</template>
    ...
    methods: {
      ...
      canvasChange() {
        ...
        html2canvas(shareContent,{
          ...
          width:imageWrapper.offsetWidth - 73,                   // 因为多出的需要剪裁掉，
          height:imageWrapper.offsetHeight + 20,
          logging:false,
        }).then(canvas => {
...
.public {
  background:radial-gradient(circle,rgba(59,60,61,1),rgba(95,96,97,1),rgba(56,57,58,1));
  padding: 9px 0;
  .public-extend {
    width: 300px;
    height: 534px;
